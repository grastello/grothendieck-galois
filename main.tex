...
\begin{proof}[Naturality in \(X\)]
  ...
  Given an arrow \(\fun{f}{X}{Y}\) of \(\cat{C}\) we want to prove that \(\psi_{EX}\) is a natural transformation \(\homs{A/H}{-}\Rightarrow \tgset(E, \homs{A}{-}_G)\) i.e that the following diagram commutes.
  \begin{center}
    \begin{tikzcd}[sep=huge]
